...
Level.prototype.init = function(){
    ...
    this.spiller = new Spiller(Atlas.typer.KommandoKompeAtlas,"komandoKalleFigur",2*config.pikselPerMeter,ctx.canvas.height,
...
Level.prototype.oppdater = function(){
...
Level.prototype.lagNyFiendeBølge = function(){
    this.runde.nr++;
